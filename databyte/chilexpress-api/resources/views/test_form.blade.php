...
@section('page-title')
    {{ trans('chilexpress-api::pages/quote_test.calculate.page_title') }}
@endsection
...
@section('page-header')
- {{ trans('chilexpress-api::pages/quote_test.calculate.page_header') }}
@endsection

@include('administration-ui::partials.page.breadcrumbs', [ 'breadcrumbs' => [
    ['text' => trans('chilexpress-api::pages/quote_test.calculate.breadcrumb')]
]])

@section('page-content')

    {!! Form::open(['route' => ['chilexpress-api::quote-result'], 'class' => 'has-max-width']) !!}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('origin_county_code', trans('chilexpress-api::pages/quote_test.fields.origin_county_code'), []) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('destination_county_code', trans('chilexpress-api::pages/quote_test.fields.destination_county_code'), []) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('package_weight', trans('chilexpress-api::pages/quote_test.fields.package_weight'), []) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('package_height', trans('chilexpress-api::pages/quote_test.fields.package_height'), []) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('package_width', trans('chilexpress-api::pages/quote_test.fields.package_width'), []) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('package_length', trans('chilexpress-api::pages/quote_test.fields.package_length'), []) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('product_type', trans('chilexpress-api::pages/quote_test.fields.product_type'), []) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('content_type', trans('chilexpress-api::pages/quote_test.fields.content_type'), []) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('declared_worth', trans('chilexpress-api::pages/quote_test.fields.declared_worth'), []) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    {!! Form::label('delivery_time', trans('chilexpress-api::pages/quote_test.fields.delivery_time'), []) !!}
            ...
            <div class="card-footer">
                <div class="row justify-content-end">
                    <div class="col-12 btn-demo">
                        {!! Form::submit(trans('chilexpress-api::pages/quote_test.fields.submit.quote'), [
                            'class' => 'btn btn-info float-right btn-submit',
                            'name' => 'quote',
                            'title' => trans('chilexpress-api::pages/quote_test.fields.submit.quote')
                            ]) !!}
                    </div>
                </div>
            </div>
